      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="relative">
            <img src="/image1.jpg" alt="Hotel Pool" className="rounded-lg shadow-md w-48 object-cover h-80" />
            <img src="/image2.jpg" alt="Hotel Room" className="rounded-lg shadow-md absolute right-0 bottom-10 transform translate-x-1/8 w-2/3 h-60 object-cover" />
